...
INSERT INTO public.skill_histories VALUES (84, 462, 56, NULL, 'intermediate', 'Approved by admin (ID: 10)', '2025-03-20 11:29:06.062025');
INSERT INTO public.skill_histories VALUES (85, 463, 53, NULL, 'intermediate', 'Approved by admin (ID: 10)', '2025-03-20 11:29:14.493916');
INSERT INTO public.skill_histories VALUES (86, 464, 55, NULL, 'beginner', 'Approved by admin (ID: 10)', '2025-03-20 11:29:17.864434');
INSERT INTO public.skill_histories VALUES (88, 466, 10, NULL, 'expert', 'Approved by admin (ID: 10)', '2025-04-16 19:32:56.091319');
INSERT INTO public.skill_histories VALUES (89, 466, 10, 'beginner', 'beginner', 'Auto-approved admin update', '2025-04-18 06:44:16.076519');
INSERT INTO public.skill_histories VALUES (93, 471, 44, NULL, 'expert', 'Approved by admin (ID: 69)', '2025-04-21 14:52:22.000202');


--
-- Data for Name: skill_target_skills; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.skill_target_skills VALUES (11, 12, 412);
INSERT INTO public.skill_target_skills VALUES (12, 13, 434);


--
-- Data for Name: skill_target_users; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: skill_targets; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.skill_targets VALUES (12, 'Java', '009', 'expert', '2025-03-26', '2025-03-14 17:09:06.913982', '2025-03-14 17:09:06.913982', 2349);
INSERT INTO public.skill_targets VALUES (13, 'Q2 Scala', 'awe', 'intermediate', '2025-03-29', '2025-03-14 17:30:28.184313', '2025-03-14 17:30:28.184313', 22);


--
-- Data for Name: skill_templates; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.skill_templates VALUES (1, 'Scala', 'Programming', 'Java on steroids', true, 'intermediate', '2025-03-29', '2025-03-14 17:16:17.181729', '2025-03-14 17:16:17.181729');
...
--
-- Name: endorsements_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: pending_skill_updates_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.pending_skill_updates_id_seq', 45, true);


--
-- Name: profile_histories_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.profile_histories_id_seq', 38, true);


--
-- Name: project_resource_histories_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.project_resource_histories_id_seq', 39, true);


--
-- Name: project_resources_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.project_resources_id_seq', 13, true);


--
-- Name: project_skills_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.project_skills_id_seq', 4, true);
...
--
-- Name: skill_approvers_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.skill_approvers_id_seq', 20, true);
...
SELECT pg_catalog.setval('public.skill_categories_id_seq', 15, true);


--
-- Name: skill_histories_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.skill_histories_id_seq', 93, true);


--
-- Name: skill_subcategories_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.skill_subcategories_id_seq', 75, true);


--
-- Name: skill_target_skills_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.skill_target_skills_id_seq', 12, true);


--
-- Name: skill_target_users_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.skill_target_users_id_seq', 1, false);


--
-- Name: skill_targets_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.skill_targets_id_seq', 13, true);


--
-- Name: skill_templates_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.skill_templates_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.skills_id_seq', 471, true);
